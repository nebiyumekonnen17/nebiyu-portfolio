...
export const skillCategories: SkillCategory[] = [
  {
    ...
    skills: [
      { name: "AWS Amplify", usedIn: [p("degissnap", "DegisSnap")] },
      { name: "Amazon Cognito", usedIn: [p("degissnap", "DegisSnap")] },
      { name: "AWS AppSync", usedIn: [p("degissnap", "DegisSnap")] },
      { name: "Amazon DynamoDB", usedIn: [p("degissnap", "DegisSnap")] },
      { name: "Amazon S3", usedIn: [p("degissnap", "DegisSnap")] },
      { name: "AWS AppConfig patterns", usedIn: [p("nehas-digital-signage", "Nehas Digital Signage")] },
      { name: "Regional deployment and environment management", usedIn: [p("degissnap", "DegisSnap")] },
  ...
  },
  {
    ...
    skills: [
      { name: "React", usedIn: [p("degissnap", "DegisSnap")] },
      { name: "Vite", usedIn: [p("degissnap", "DegisSnap")] },
      { name: "TypeScript", usedIn: [p("naep", "NAEP")] },
      { name: "Node.js", usedIn: [p("fsss-limat-pos", "FSSS Limat POS")] },
      { name: "GraphQL API design", usedIn: [p("degissnap", "DegisSnap")] },
  ...
  },
  {
    ...
    skills: [
      { name: "Authentication and identity design", usedIn: [p("degissnap", "DegisSnap")] },
      { name: "Authorization and ownership rules", usedIn: [p("degissnap", "DegisSnap")] },
      { name: "Role based access control", usedIn: [p("fsss-limat-pos", "FSSS Limat POS")] },
      { name: "Security fundamentals", usedIn: [p("degissnap", "DegisSnap")] },
    ],
  },
  {
