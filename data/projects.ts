...
export const projects: Project[] = [
  ...
  },
  {
    ...
    summary:
      "Private product development for a multi vendor marketplace intended to connect Ethiopian designers, artisans, boutiques, and tailors with customers worldwide.",
    ...
    contribution: [
      { label: "Product planning", description: "Defined the proposed marketplace model connecting multiple seller types with international customers." },
      { label: "System planning", description: "Mapped the planned multi vendor structure, including seller onboarding, subscriptions, commission, and payouts." },
      { label: "UI and UX direction", description: "Explored the measurement profile concept and a bilingual English and Amharic experience." },
    ],
    features: [
      { title: "Customer and seller accounts", description: "Planned account types for shoppers and the designers, artisans, boutiques, and tailors selling to them." },
      { title: "Product catalog", description: "A planned shared catalog spanning multiple independent sellers." },
      { title: "Universal and family measurement profiles", description: "A concept for saving measurements for customers and the family members they shop for." },
      { title: "Orders, tracking, returns, and refunds", description: "A proposed ecommerce order lifecycle designed around international shipping." },
      { title: "Dispute protection", description: "A planned process for resolving problems between customers and sellers." },
      { title: "Seller onboarding, subscriptions, and commission", description: "The proposed model for seller access and marketplace revenue." },
      { title: "Payouts and shipping", description: "Planned workflows for seller payouts and international delivery." },
      { title: "English and Amharic MVP", description: "The first release is intended to be bilingual, with room for more Ethiopian languages later." },
      { title: "Dark mode and light mode", description: "Both themes are part of the product direction." },
    ],
    challenges: [
      {
        title: "Designing sizing that actually works for traditional wear",
        description: "Standard international sizing does not map cleanly onto traditional Ethiopian clothing. The proposed universal and family measurement profiles explore solving that at the account level instead of leaving it to guesswork at checkout.",
      },
      {
    ...
    relatedCredentialNames: ["Project Management Fundamentals"],
    evidence: ["Private product requirements and marketplace model", "Measurement-profile concept", "Bilingual information architecture", "Concept UI explorations"],
    notes: "Private product development. The repository and development environment are intentionally not public. This case study is limited to high-level product direction; the gallery contains concept explorations, not screenshots of a launched marketplace.",
  },
  {
    slug: "aradacart",
    name: "AradaCart",
