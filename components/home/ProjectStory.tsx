    ...
    <div className="project-story-grid">
      <div className="project-story-copy">
        {projects.map((project, index) => (
          ...
          >
            ...
            <Link href={`/projects/${project.slug}`} className="home-inline-link">
      ...
      <aside className="project-story-visual" aria-live="polite">
        {projects.map((project, index) => (
          <div
            key={project.slug}
            className={`project-frame project-showcase ${active === index ? "is-active" : ""}`}
          >
            ...
            <div className="project-frame-image">
              <div className="project-showcase-surface">
                <Image
